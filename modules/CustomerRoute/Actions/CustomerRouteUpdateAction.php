...
class CustomerRouteUpdateAction
{
    public function execute(CustomerRoute $customerRoute, CustomerRouteData $data): CustomerRoute
    {
        $customerRoute->update([
