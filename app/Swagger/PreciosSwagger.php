...
{
    // --- PRICES ---
    #[OA\Get(path: '/prices', summary: 'Listar precios (paginado)', tags: ['Precios'],
        security: [['sanctum' => []]],
    ...
    #[OA\Post(path: '/prices', summary: 'Crear precio', tags: ['Precios'],
        security: [['sanctum' => []]],
    ...
    #[OA\Get(path: '/prices/{id}', summary: 'Obtener precio', tags: ['Precios'],
        security: [['sanctum' => []]],
    ...
    #[OA\Put(path: '/prices/{id}', summary: 'Actualizar precio', tags: ['Precios'],
        security: [['sanctum' => []]],
        parameters: [new OA\Parameter(name: 'id', in: 'path', required: true, schema: new OA\Schema(type: 'integer'))],
    ...
    #[OA\Delete(path: '/prices/{id}', summary: 'Eliminar precio', tags: ['Precios'],
        security: [['sanctum' => []]],
        parameters: [new OA\Parameter(name: 'id', in: 'path', required: true, schema: new OA\Schema(type: 'integer'))],
    ...
    // --- PRICE PRODUCTS ---
    #[OA\Get(path: '/price_products', summary: 'Listar productos de precio', tags: ['Precios'],
        security: [['sanctum' => []]],
        parameters: [new OA\Parameter(name: 'per_page', in: 'query', required: false, schema: new OA\Schema(type: 'integer', default: 15))],
    ...
    #[OA\Post(path: '/price_products', summary: 'Crear producto de precio', tags: ['Precios'],
        security: [['sanctum' => []]],
        requestBody: new OA\RequestBody(required: true, content: new OA\JsonContent(
    ...
    #[OA\Get(path: '/price_products/{id}', summary: 'Obtener producto de precio', tags: ['Precios'],
        security: [['sanctum' => []]],
        parameters: [new OA\Parameter(name: 'id', in: 'path', required: true, schema: new OA\Schema(type: 'integer'))],
        responses: [new OA\Response(response: 200, description: 'Detalle')]
    )]
    ...
    #[OA\Put(path: '/price_products/{id}', summary: 'Actualizar producto de precio', tags: ['Precios'],
        security: [['sanctum' => []]],
        parameters: [new OA\Parameter(name: 'id', in: 'path', required: true, schema: new OA\Schema(type: 'integer'))],
        requestBody: new OA\RequestBody(required: true, content: new OA\JsonContent(properties: [
            new OA\Property(property: 'prc_code', type: 'string', maxLength: 18),
    ...
    #[OA\Delete(path: '/price_products/{id}', summary: 'Eliminar producto de precio', tags: ['Precios'],
        security: [['sanctum' => []]],
        parameters: [new OA\Parameter(name: 'id', in: 'path', required: true, schema: new OA\Schema(type: 'integer'))],
    ...
    // --- TAXES ---
    #[OA\Get(path: '/taxes', summary: 'Listar impuestos', tags: ['Precios'],
        security: [['sanctum' => []]],
        parameters: [new OA\Parameter(name: 'per_page', in: 'query', required: false, schema: new OA\Schema(type: 'integer', default: 15))],
        responses: [new OA\Response(response: 200, description: 'Lista')]
    )]
    ...
    #[OA\Post(path: '/taxes', summary: 'Crear impuesto', tags: ['Precios'],
        security: [['sanctum' => []]],
        requestBody: new OA\RequestBody(required: true, content: new OA\JsonContent(
    ...
    #[OA\Get(path: '/taxes/{id}', summary: 'Obtener impuesto', tags: ['Precios'],
        security: [['sanctum' => []]],
        parameters: [new OA\Parameter(name: 'id', in: 'path', required: true, schema: new OA\Schema(type: 'integer'))],
        responses: [new OA\Response(response: 200, description: 'Detalle')]
    )]
    ...
    #[OA\Put(path: '/taxes/{id}', summary: 'Actualizar impuesto', tags: ['Precios'],
        security: [['sanctum' => []]],
        parameters: [new OA\Parameter(name: 'id', in: 'path', required: true, schema: new OA\Schema(type: 'integer'))],
        requestBody: new OA\RequestBody(required: true, content: new OA\JsonContent(properties: [
            new OA\Property(property: 'tax_code', type: 'string', maxLength: 4),
    ...
    #[OA\Delete(path: '/taxes/{id}', summary: 'Eliminar impuesto', tags: ['Precios'],
        security: [['sanctum' => []]],
        parameters: [new OA\Parameter(name: 'id', in: 'path', required: true, schema: new OA\Schema(type: 'integer'))],
    ...
    // --- TAXATIONS ---
    #[OA\Get(path: '/taxations', summary: 'Listar clasificaciones fiscales', tags: ['Precios'],
        security: [['sanctum' => []]],
        parameters: [new OA\Parameter(name: 'per_page', in: 'query', required: false, schema: new OA\Schema(type: 'integer', default: 15))],
        responses: [new OA\Response(response: 200, description: 'Lista')]
    )]
    ...
    #[OA\Post(path: '/taxations', summary: 'Crear clasificación fiscal', tags: ['Precios'],
        security: [['sanctum' => []]],
        requestBody: new OA\RequestBody(required: true, content: new OA\JsonContent(
    ...
    #[OA\Get(path: '/taxations/{id}', summary: 'Obtener clasificación fiscal', tags: ['Precios'],
        security: [['sanctum' => []]],
        parameters: [new OA\Parameter(name: 'id', in: 'path', required: true, schema: new OA\Schema(type: 'integer'))],
        responses: [new OA\Response(response: 200, description: 'Detalle')]
    )]
    ...
    #[OA\Put(path: '/taxations/{id}', summary: 'Actualizar clasificación', tags: ['Precios'],
        security: [['sanctum' => []]],
        parameters: [new OA\Parameter(name: 'id', in: 'path', required: true, schema: new OA\Schema(type: 'integer'))],
        requestBody: new OA\RequestBody(required: true, content: new OA\JsonContent(properties: [
            new OA\Property(property: 'txn_code', type: 'string', maxLength: 5),
    ...
    #[OA\Delete(path: '/taxations/{id}', summary: 'Eliminar clasificación', tags: ['Precios'],
        security: [['sanctum' => []]],
        parameters: [new OA\Parameter(name: 'id', in: 'path', required: true, schema: new OA\Schema(type: 'integer'))],
    ...
    // --- TAXATION TAXES ---
    #[OA\Get(path: '/taxation_taxes', summary: 'Listar impuestos por clasificación', tags: ['Precios'],
        security: [['sanctum' => []]],
        parameters: [new OA\Parameter(name: 'per_page', in: 'query', required: false, schema: new OA\Schema(type: 'integer', default: 15))],
        responses: [new OA\Response(response: 200, description: 'Lista')]
    )]
    ...
    #[OA\Post(path: '/taxation_taxes', summary: 'Crear impuesto por clasificación', tags: ['Precios'],
        security: [['sanctum' => []]],
        requestBody: new OA\RequestBody(required: true, content: new OA\JsonContent(
    ...
    #[OA\Get(path: '/taxation_taxes/{id}', summary: 'Obtener impuesto por clasificación', tags: ['Precios'],
        security: [['sanctum' => []]],
        parameters: [new OA\Parameter(name: 'id', in: 'path', required: true, schema: new OA\Schema(type: 'integer'))],
        responses: [new OA\Response(response: 200, description: 'Detalle')]
    )]
    ...
    #[OA\Put(path: '/taxation_taxes/{id}', summary: 'Actualizar impuesto por clasificación', tags: ['Precios'],
        security: [['sanctum' => []]],
        parameters: [new OA\Parameter(name: 'id', in: 'path', required: true, schema: new OA\Schema(type: 'integer'))],
        requestBody: new OA\RequestBody(required: true, content: new OA\JsonContent(properties: [
            new OA\Property(property: 'ttx_code', type: 'string', maxLength: 18),
    ...
    #[OA\Delete(path: '/taxation_taxes/{id}', summary: 'Eliminar impuesto por clasificación', tags: ['Precios'],
        security: [['sanctum' => []]],
        parameters: [new OA\Parameter(name: 'id', in: 'path', required: true, schema: new OA\Schema(type: 'integer'))],
        responses: [new OA\Response(response: 200, description: 'Impuesto eliminado')]
    )]
